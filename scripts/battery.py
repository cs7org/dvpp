...
class battery(object):
	"""Simple battery model based on [1] https://www.researchgate.net/publication/319351878_Investigation_modeling_and_simulation_of_redox-flow_lithium-ion_and_lead-acid_battery_systems_for_home_storage_applications
    Fit of inverter parameterization unfortunately not pupbllicly available
    """
	def __init__(self, Emax, Pmax_ch, Pmax_dch, Estart):		
		...
		##Inverter parameters (fit yourself according to [1])
		self.ac =
		self.bc =
		self.cc =
		self.ad =
